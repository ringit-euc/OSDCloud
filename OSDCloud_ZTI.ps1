...
Write-Host " "
Write-Host "1: Zero-Touch Windows 11 24H2 | en-us | Professional" -ForegroundColor Cyan
Write-Host "2: Zero-Touch Windows 11 25H2 | en-us | Professional" -ForegroundColor Cyan
...
switch ($input)
{
    '1' { Start-OSDCloud -OSLanguage en-us -OSName 'Windows 11 24H2 x64' -OSEdition Pro -OSLicense Retail -ZTI -Firmware -SkipAutopilot -SkipODT }
    '2' { Start-OSDCloud -OSLanguage en-us -OSName 'Windows 11 25H2 x64' -OSEdition Pro -OSLicense Retail -ZTI -Firmware -SkipAutopilot -SkipODT }
    '3' { Start-OSDCloudGUI } 
    '4' { Exit }  
}
