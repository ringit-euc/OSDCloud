...
Write-Host "2: Zero-Touch Windows 11 21H2 | en-us | Professional" -ForegroundColor Yellow
...
switch ($input)
{
    ...
    '2' { Start-OSDCloud -OSLanguage en-us -OSVersion 'Windows 11' -OSBuild 21H2 -OSEdition Pro -OSLicense Retail -ZTI -Firmware -SkipAutopilot -SkipODT }
    '3' { Exit }  
}
